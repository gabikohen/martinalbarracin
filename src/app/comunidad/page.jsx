...
export default function ComunidadSection() {
  ...
  /* ✅ Ascensos de categoría — incluye MA9 y etiqueta */
  const categorias = [
    { nombre: "MA5", valor: 142, etiqueta: "ascensos" },
    { nombre: "MA6", valor: 87, etiqueta: "ascensos" },
    { nombre: "MA7", valor: 64, etiqueta: "ascensos" },
    { nombre: "MA8", valor: 41, etiqueta: "ascensos" },
    { nombre: "MA9", valor: 27, etiqueta: "ascensos" },
  ];
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 mb-16">
          <motion.div
            ...
            className="p-6 rounded-2xl bg-white/5 backdrop-blur-md border border-white/12 shadow-lg hover:border-white/20 transition-all duration-300 ease-in-out text-center relative overflow-hidden group"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 sm:gap-8 mb-16">
          {categorias.map((c, i) => (
            <motion.div
              ...
              className="p-6 rounded-2xl bg-white/5 backdrop-blur-md border border-white/12 hover:border-green-500/25 shadow-xl hover:shadow-green-500/15 transition-all duration-300 ease-in-out text-center relative overflow-hidden group"
              aria-label={`Tarjeta ${c.nombre}`}
            >
              <div className="absolute inset-0 bg-gradient-to-br from-green-500/8 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              <div className="relative">
